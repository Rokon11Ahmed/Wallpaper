...
public class HomeFragment extends Fragment  implements EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        rc = root.findViewById(R.id.main_list);
        spinKitView = root.findViewById(R.id.spin_kit);
        tv_warning = root.findViewById(R.id.no_net);
