...
import com.example.wallpaper.MainListAdapter;
...
import static com.example.wallpaper.MyUtils.isOnline;

import pub.devrel.easypermissions.AppSettingsDialog;
import pub.devrel.easypermissions.EasyPermissions;
import pub.devrel.easypermissions.PermissionRequest;

public class GalleryFragment extends Fragment implements EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        rc = root.findViewById(R.id.iphone_list);
        spinKitView = root.findViewById(R.id.iSpin_kit);
        tv_warning = root.findViewById(R.id.iNo_net);
        ...
        mAdView = root.findViewById(R.id.iAdView);
        loadBanner();

        mDatabase = FirebaseDatabase.getInstance().getReference().child("iphone");
