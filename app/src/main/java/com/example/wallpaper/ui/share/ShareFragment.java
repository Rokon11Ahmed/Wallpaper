package com.example.wallpaper.ui.share;
...
public class ShareFragment extends Fragment implements EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("xiaomi");
