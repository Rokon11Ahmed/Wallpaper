...
public class SlideshowFragment extends Fragment implements EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("samsung");
